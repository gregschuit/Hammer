...
TRAIN_ANNOTATIONS=/home/gregschuit/projects/data/annotations/enlarged_cardiac_PA_train.txt
VALID_ANNOTATIONS=/home/gregschuit/projects/data/annotations/enlarged_cardiac_PA_valid.txt

./scripts/dist_train.sh ${GPUS} stylegan2 \
    --job_name='c_stylegan2_imagenome256_enlarged_cardiac_pa_resized_mirror=false' \
    --seed=0 \
    --resolution=256 \
    --image_channels=1 \
